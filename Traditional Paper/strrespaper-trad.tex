...
\tptitle{RESEARCH PROJECT TITLE \\
	(UPPERCASE except for Scientific names, FONT – TIMES NEW ROMAN, SIZE 12; \\
	AT THE CENTER, INVERTED PYRAMID)
} % Format this to make it the title an inverted pyramid
\resone{Researcher D. One} % Names in alphabetical order (First M.I. Family Name)
\restwo{A\~na B. Two}
\resthree{Scholar N. Bayan}
