...
\begin{document}
	...
	\unnumchapter*{APPROVAL SHEET}
		\hspace*{\parindent}This research paper entitled, \enquote{\MakeTextUppercase{\@title}} submitted by\printauthors{} has been examined and recommended for approval.
