...
\begin{document}
	...
	\chapter{RESULTS AND DISCUSSION}
		...
		\paragraph{Results}
			...
			The solution to Equation~\ref{eq:meeq} is Equation~\ref{eq:samp} and is shown in Figure~\ref{fig:samplebargraph} and Table~\ref{tab:sample_characteristics} \autocite{al-shemmeriWindTurbines2010} (Listing~\ref{lst:game.py}).
