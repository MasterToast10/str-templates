...
\newscientificname{At}{A. thaliana}{Arabidopsis thaliana}
...
\begin{document}
	...
	\chapter{INTRODUCTION}
		\section{Background of the Study}
			...
			Our specific example is the \acrshort{sus}.
			The \gls{sus} is used in a variety of applications.
			The \gls{sus} is a Likert scale.
			The \acrlong{sus} is used in evaluating the usability of a system.
