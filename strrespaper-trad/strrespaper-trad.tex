...
\title{RESEARCH PROJECT TITLE} % TODO: Put your proper title here
\dayofmonth{13} % TODO: Day of month (Depends on prof)
\date{May 2019} % TODO: Date (MMMMM-YYYY; Also depends on prof)
...
\level{3} % TODO: STR Year Level


% TODO: Setup for PDF Metadata (pdfauthor and pdfkeywords)
\makeatletter
\hypersetup{
	pdftitle={\@title},
	pdfauthor={Researcher One, A\~na Two, Scholar Bayan},
	pdfkeywords={stemres, research, paper, template}
}
\makeatother
...
\begin{document}
	...
	\makeacknowledgement{
		\textquote[\autocite{thecharlesworthgroupWhatIncludeYour2020}]{%
	...
	\chapter{INTRODUCTION}
		\section{Background of the Study}
			...
			\textquote[\autocite{sachdevHowWriteBackground2018}]{%
		...
		\section{Significance of the Study}
			...
			\textquote[\autocite{WritingThesisSignificance2016}]{%
	...
	\chapter{REVIEW OF RELATED LITERATURE}
		...
		\section*{Identifying Themes, Debates, and Gaps}
			\textquote[\autocite{mccombesLiteratureReviewComplete2019}]{%
		...
		\section*{Outlining the Structure of the Literature Review}
			...
			\subsection{Chronological Order}
				\textquote[\autocite{friedlanderPrinciplesOrganization2004}]{%
	...
	\chapter{RESULTS AND DISCUSSION}
		...
		\textquote[\autocite{skillsyouneed.comDissertationWritingResults2020}]{The Results section should set out your key experimental results, including any statistical analysis and whether or not the results of these are significant}.
		...
		\subsection*{Softening Points}
			...
			Take advantage of citations with \BibLaTeX{} like so: \fullcite[182--183]{ruanDoesWritingSystem2018}.
			...
			\blockquote{\textcite{al-shemmeriWindTurbines2010} states that the solution to Equation~\ref{eq:meeq} is Equation~\ref{eq:samp} and is shown in Figure~\ref{fig:samplebargraph} and Table~\ref{tab:sample_characteristics}  (Listing~\ref{lst:game.py}).}
			One may also refer to appendices similar to the following:
			\blockquote{Relevant documentation is included in \href{apx:documentation}{Appendix}.}
			Although unconventional, if need be, one may reference another chapter like so:
			\blockquote{As detailed in \href{chp:materials_and_methods}{Chapter 3}\ref{chp:materials_and_methods} on page~\pageref{chp:materials_and_methods}\dots}

	\chapter{CONCLUSION AND RECOMMENDATIONS}
		% TODO: Conclusion and Recommendations
		\textquote[\autocite{monashuniversityConclusionsRecommendations2020}]{%
	...
	\chapter{DOCUMENTATION} \label{apx:documentation}
		...
		\begin{figure}[htbp]
			\centering
			\subfloat[We]{
				\includegraphics[width=0.45\linewidth]{../sample/graphics/bernard-hermant-IhcSHrZXFs4-unsplash.jpg}
			} \qquad
			\subfloat[Are]{
				\includegraphics[width=0.45\linewidth]{../sample/graphics/bernard-hermant-IhcSHrZXFs4-unsplash.jpg}
			}
